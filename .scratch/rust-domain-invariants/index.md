...
|---|---|---|---|
| [T00](tickets/T00-decide-effective-mount-destination-admission.md) | Decide effective mount destination admission | — | pending |
| [T01](tickets/T01-derive-machine-identity-and-validate-local-lifecycle-payloads.md) | Derive Machine identity and validate local lifecycle payloads | — | pending |
| [T02](tickets/T02-serialize-reset-and-container-admission.md) | Serialize reset and container admission | T01 | pending |
| [T03](tickets/T03-separate-requested-and-scoped-volume-sources.md) | Separate requested and scoped volume sources | — | pending |
| [T04](tickets/T04-check-resource-quantities-and-cpu-conversion.md) | Check resource quantities and CPU conversion | — | pending |
...
| [T09](tickets/T09-make-container-observations-coherent.md) | Make Container observations coherent | — | pending |
...
| [T13](tickets/T13-validate-relay-endpoints-before-pairing-persistence.md) | Validate Relay endpoints before pairing persistence | — | pending |
...
| [T18](tickets/T18-encode-ambiguity-minimum-cardinality.md) | Encode ambiguity minimum cardinality | — | pending |
