...
use ployz_core::{
    ...
    ContainerRuntimeObservation, HealthObservation, HealthcheckSpec, ImageSummary,
    LocalMachinePhase, MachineId, MachineImages, RpcErrorCode, ServiceId, ServiceName, ValueError,
};
...
impl ContainerRuntime {
    ...
    pub fn replicating(
        ...
        self.sink = Some(ObservationSink { replicated, local });
        self
    }
