...
export const PLOYZ_TABLES = {
  ...
  volume_remove_attempt: { scope: "organization", whereColumn: "organization_id",
    columns: ["id", "organization_id", "environment_id", "environment_resource_id", "status", "terminal_at"],
  },
