...
import { asString } from "#/lib/json.ts"
...
type SidebarMenuButtonTooltip = string | React.ComponentProps<typeof TooltipContent>

function isSidebarTooltipText(
  tooltip: SidebarMenuButtonTooltip,
): tooltip is string {
  return asString(tooltip) !== null
}
...
function SidebarMenuButton({
  ...
  if (isSidebarTooltipText(tooltip)) {
    return (
      <Tooltip>
        {comp}
        <TooltipContent
