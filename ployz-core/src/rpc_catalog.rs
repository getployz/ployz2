    ...
    ($consumer:ident) => {
        $consumer! {
            ...
            unary {
                ...
                CreateVolume: (create_volume, "CreateVolume", CreateVolumeRequest, "create_volume", VolumeCreated, CREATE_VOLUME_CAPABILITY, "ployz.volume.create.v1", Container),
                ...
                InspectVolume: (inspect_volume, "InspectVolume", InspectVolumeRequest, "inspect_volume", VolumeDetails, INSPECT_VOLUME_CAPABILITY, "ployz.volume.inspect.v1", Container),
