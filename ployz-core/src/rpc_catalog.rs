    ...
    ($consumer:ident) => {
        $consumer! {
            ...
            unary {
                ...
                CreateVolume: (create_volume, "CreateVolume", CreateVolumeRequest, "create_volume", DockerVolume),
                ListVolumes: (list_volumes, "ListVolumes", ListVolumesRequest, "list_volumes", VolumeList),
                InspectVolume: (inspect_volume, "InspectVolume", InspectVolumeRequest, "inspect_volume", DockerVolume),
