...
use crate::{ContainerKind, ContainerObservation, PartialResult, ServiceId, ServiceSelector};
    ...
    let matches = services
        ...
        .filter(|service| {
            service
                ...
                .any(|container| container.service_name.as_str() == selector.as_str())
        })
        .collect::<Vec<_>>();
...
mod tests {
    ...
    use crate::{
        ...
        RpcErrorCode, ServiceId, ServiceName, ServiceSelector,
    };
