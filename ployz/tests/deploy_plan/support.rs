...
pub(super) use ployz_core::{
    ...
    ManagementAddress, MembershipObservation, Placement, PortPublication, PreDeployHook,
    PullPolicy, RequestedServiceSpec, ResolvedServiceSpec, ResolvedUpdateConfig,
