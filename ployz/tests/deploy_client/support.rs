...
use ployz_core::{
    AdvertisedEndpoint, CaddyConfigPreflighted, CaddyServiceConfig, ContainerCreated,
    ContainerDetails, ContainerId, ContainerKind, ContainerList, ContainerPath,
    ContainerRuntimeObservation, ContractDescription, DockerVolume, DockerVolumeId,
    DockerVolumeName, Domain, HealthObservation, LocalMachinePhase, Machine, MachineDetails,
    MachineId, MachineImages, MachineList, MachineName, MachineObservation, MachineRpc,
    MachineRpcServer, ManagementAddress, MembershipObservation, OpaquePayload, PROTOCOL_MAJOR,
    ProjectName, QualifiedService, RequestedServiceSpec, ResolvedUpdateConfig, RpcError,
...
pub(super) struct DeployService {
    ...
    preflight_services: Arc<Mutex<BTreeMap<QualifiedService, CaddyServiceConfig>>>,
...
impl DeployService {
    pub(super) fn new(machine: MachineObservation) -> Self {
        Self {
            ...
            preflight_services: Arc::new(Mutex::new(BTreeMap::new())),
    ...
    pub(super) fn preflight_services(
        &self,
    ) -> Arc<Mutex<BTreeMap<QualifiedService, CaddyServiceConfig>>> {
    ...
    async fn preflight_caddy_config(
        ...
        *self.preflight_services.lock().unwrap() = preflight.services;
        match &self.caddy_preflight_error {
            ...
            None => encoded(RpcResponse::from(CaddyConfigPreflighted {})),
        }
    }
