use ployz_core::{
    ...
    DESCRIBE_CONTRACT_CAPABILITY, END_BUILD_GRANT_CAPABILITY, ENSURE_IMAGE_INGEST_CAPABILITY,
    EXEC_CONTAINER_CAPABILITY, GET_INGRESS_PROXY_CONFIG_CAPABILITY, INITIALIZE_MACHINE_CAPABILITY,
    INSPECT_CONTAINER_CAPABILITY, INSPECT_MACHINE_CAPABILITY, INSPECT_MACHINE_UPGRADE_CAPABILITY,
    INSPECT_STORAGE_CAPABILITY, INSPECT_VOLUME_CAPABILITY, INSPECT_WIREGUARD_CAPABILITY,
    ...
    MACHINE_STORAGE_OBSERVATION_CAPABILITY, MACHINE_TOKEN_CAPABILITY, MINT_BUILD_GRANT_CAPABILITY,
    PREPARE_VOLUMES_CAPABILITY, PUBLISH_CERTIFICATE_MATERIAL_CAPABILITY,
    PULL_IMAGE_FROM_MACHINE_CAPABILITY, REGISTER_MACHINE_CAPABILITY, REMOVE_CONTAINER_CAPABILITY,
    REMOVE_IMAGES_CAPABILITY, REMOVE_LOCAL_MACHINE_CAPABILITY, REMOVE_MACHINE_CAPABILITY,
    REMOVE_VOLUME_CAPABILITY, REQUEST_MACHINE_UPGRADE_CAPABILITY, RESET_MACHINE_CAPABILITY,
