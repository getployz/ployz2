use ployz_core::{
    ...
    ENSURE_IMAGE_INGEST_CAPABILITY, EXEC_CONTAINER_CAPABILITY, GET_DOMAIN_CAPABILITY,
    ...
    REMOVE_VOLUME_CAPABILITY, REQUEST_MACHINE_UPGRADE_CAPABILITY, RESERVE_DOMAIN_CAPABILITY,
