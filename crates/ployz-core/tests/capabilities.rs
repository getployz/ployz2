use ployz_core::{
    ...
    INSPECT_CONTAINER_CAPABILITY, INSPECT_MACHINE_CAPABILITY, INSPECT_STORAGE_CAPABILITY,
    ...
    LIST_VOLUMES_CAPABILITY, MACHINE_LOGS_CAPABILITY, MACHINE_STORAGE_OBSERVATION_CAPABILITY,
    MACHINE_TOKEN_CAPABILITY, PREPARE_VOLUMES_CAPABILITY, PULL_IMAGE_FROM_MACHINE_CAPABILITY,
