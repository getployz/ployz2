...
export const resolveWorkingComparison = input => request({ operation: 'working_comparison', ...input });
...
export const parseSavedDiscard = value => request({ operation: 'parse_saved_discard', value });
