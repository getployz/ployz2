...
5. ✓ **Remote Reads declare freshness.** Every `queryOptions`, and every options object with a `queryFn`, sets `staleTime`; only Org Store tables inherit the `createApiCollection` default.
