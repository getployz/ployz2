...
import { asFiniteNumber, asString } from "#/lib/json";
...
const defaultConfig: ClassValue[] = [
  ...
  "not-has-data-wf-right-sidebar:not-has-data-wf-secondary-right-sidebar:mr-[env(safe-area-inset-right)]",
  ...
  "min-wf-nav:has-data-[wf-left-sidebar=expanded]:ml-[calc(var(--left-sidebar-width-expanded)+var(--left-sidebar-left-offset)+var(--left-sidebar-right-offset)+env(safe-area-inset-left))]",
  // HAS RIGHT SIDEBAR=EXPANDED, ADD RIGHT MARGIN WIREFRAME CONTENT
  "min-wf-nav:has-data-[wf-right-sidebar=expanded]:mr-[calc(var(--right-sidebar-width-expanded)+var(--right-sidebar-right-offset)+var(--right-sidebar-left-offset)+env(safe-area-inset-right))]",
  // HAS LEFT SIDEBAR=COLLAPSED, ADD LEFT MARGIN WIREFRAME CONTENT
  "min-wf-nav:has-data-[wf-left-sidebar=collapsed]:ml-[calc(var(--left-sidebar-width-collapsed)+var(--left-sidebar-left-offset)+var(--left-sidebar-right-offset)+env(safe-area-inset-left))]",
  // HAS RIGHT SIDEBAR=COLLAPSED, ADD RIGHT MARGIN WIREFRAME CONTENT
  "min-wf-nav:has-data-[wf-right-sidebar=collapsed]:mr-[calc(var(--right-sidebar-width-collapsed)+var(--right-sidebar-right-offset)+var(--right-sidebar-left-offset)+env(safe-area-inset-right))]",
  // HAS SECONDARY RIGHT SIDEBAR=EXPANDED, ADD RIGHT MARGIN WIREFRAME CONTENT
  "min-wf-nav:has-data-[wf-secondary-right-sidebar=expanded]:mr-[calc(var(--secondary-right-sidebar-width-expanded)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
  // HAS SECONDARY RIGHT SIDEBAR=COLLAPSED, ADD RIGHT MARGIN WIREFRAME CONTENT
  "min-wf-nav:has-data-[wf-secondary-right-sidebar=collapsed]:mr-[calc(var(--secondary-right-sidebar-width-collapsed)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
...
const wireframeCssVariables = [
  ...
  "--secondary-right-sidebar-width-collapsed",
  "--secondary-right-sidebar-width-expanded",
  "--secondary-right-sidebar-left-offset",
  "--secondary-right-sidebar-right-offset",
  "--secondary-right-sidebar-top-offset",
  "--secondary-right-sidebar-bottom-offset",
] as const;
...
const responsiveCornersConfig = {
  navbar: {
    ...
    right: [
      ...
      // HAS RESPONSIVE NAV AND SECONDARY RIGHT SIDEBAR AND VIEWPORT IS MOBILE, ADD BOTTOM MARGIN TO SECONDARY RIGHT SIDEBAR
      "has-data-wf-responsive-nav:has-data-wf-secondary-right-sidebar:**:data-wf-secondary-right-sidebar:mb-(--bottom-nav-height)",
      // HAS RESPONSIVE NAV AND SECONDARY RIGHT SIDEBAR AND VIEWPORT IS DESKTOP, ADD TOP MARGIN TO SECONDARY RIGHT SIDEBAR
      "min-wf-nav:has-data-wf-responsive-nav:has-data-wf-secondary-right-sidebar:**:data-wf-secondary-right-sidebar:mt-(--top-nav-height) min-wf-nav:has-data-wf-responsive-nav:has-data-wf-secondary-right-sidebar:**:data-wf-secondary-right-sidebar:mb-0",
    ],
  },
  sidebar: {
    left: [
    ...
    right: [
      ...
      // HAS RESPONSIVE NAV AND SECONDARY RIGHT SIDEBAR=EXPANDED, ADD RIGHT MARGIN WIREFRAME RESPONSIVE NAV
      "has-data-wf-responsive-nav:has-data-[wf-secondary-right-sidebar=expanded]:**:data-wf-responsive-nav:mr-[calc(var(--secondary-right-sidebar-width-expanded)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
      // HAS RESPONSIVE NAV AND SECONDARY RIGHT SIDEBAR=COLLAPSED, ADD RIGHT MARGIN WIREFRAME RESPONSIVE NAV
      "has-data-wf-responsive-nav:has-data-[wf-secondary-right-sidebar=collapsed]:**:data-wf-responsive-nav:mr-[calc(var(--secondary-right-sidebar-width-collapsed)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
    ],
  },
} as const;
...
const cornersConfig = {
  navbar: {
    ...
    topRight: [
      ...
      // HAS TOP NAV AND SECONDARY RIGHT SIDEBAR, ADD TOP MARGIN TO SECONDARY RIGHT SIDEBAR
      "has-data-wf-top-nav:has-data-wf-secondary-right-sidebar:**:data-wf-secondary-right-sidebar:mt-(--top-nav-height)",
    ],
    bottomLeft: [
    ...
    bottomRight: [
      ...
      // HAS BOTTOM NAV AND SECONDARY RIGHT SIDEBAR, ADD BOTTOM MARGIN TO SECONDARY RIGHT SIDEBAR
      "has-data-wf-bottom-nav:has-data-wf-secondary-right-sidebar:**:data-wf-secondary-right-sidebar:mb-(--bottom-nav-height)",
    ],
  },
  sidebar: {
    topLeft: [
      // HAS TOP NAV AND LEFT SIDEBAR=EXPANDED, ADD LEFT MARGIN TO TOP NAV
      "min-wf-nav:has-data-wf-top-nav:has-data-[wf-left-sidebar=expanded]:**:data-wf-top-nav:ml-[calc(var(--left-sidebar-width-expanded)+var(--left-sidebar-left-offset)+var(--left-sidebar-right-offset))]",
      // HAS TOP NAV AND LEFT SIDEBAR=COLLAPSED, ADD LEFT MARGIN TO TOP NAV
      "min-wf-nav:has-data-wf-top-nav:has-data-[wf-left-sidebar=collapsed]:**:data-wf-top-nav:ml-[calc(var(--left-sidebar-width-collapsed)+var(--left-sidebar-left-offset)+var(--left-sidebar-right-offset))]",
    ],
    topRight: [
      // HAS TOP NAV AND RIGHT SIDEBAR=EXPANDED, ADD RIGHT MARGIN TO TOP NAV
      "min-wf-nav:has-data-wf-top-nav:has-data-[wf-right-sidebar=expanded]:**:data-wf-top-nav:mr-[calc(var(--right-sidebar-width-expanded)+var(--right-sidebar-right-offset)+var(--right-sidebar-left-offset))]",
      // HAS TOP NAV AND RIGHT SIDEBAR=COLLAPSED, ADD RIGHT MARGIN TO TOP NAV
      "min-wf-nav:has-data-wf-top-nav:has-data-[wf-right-sidebar=collapsed]:**:data-wf-top-nav:mr-[calc(var(--right-sidebar-width-collapsed)+var(--right-sidebar-right-offset)+var(--right-sidebar-left-offset))]",
      // HAS TOP NAV AND SECONDARY RIGHT SIDEBAR=EXPANDED, ADD RIGHT MARGIN TO TOP NAV
      "min-wf-nav:has-data-wf-top-nav:has-data-[wf-secondary-right-sidebar=expanded]:**:data-wf-top-nav:mr-[calc(var(--secondary-right-sidebar-width-expanded)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
      // HAS TOP NAV AND SECONDARY RIGHT SIDEBAR=COLLAPSED, ADD RIGHT MARGIN TO TOP NAV
      "min-wf-nav:has-data-wf-top-nav:has-data-[wf-secondary-right-sidebar=collapsed]:**:data-wf-top-nav:mr-[calc(var(--secondary-right-sidebar-width-collapsed)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
    ],
    bottomLeft: [
    ...
    bottomRight: [
      ...
      // HAS BOTTOM NAV AND SECONDARY RIGHT SIDEBAR=EXPANDED, ADD RIGHT MARGIN TO BOTTOM NAV
      "has-data-wf-bottom-nav:has-data-[wf-secondary-right-sidebar=expanded]:**:data-wf-bottom-nav:mr-[calc(var(--secondary-right-sidebar-width-expanded)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
      // HAS BOTTOM NAV AND SECONDARY RIGHT SIDEBAR=COLLAPSED, ADD RIGHT MARGIN TO BOTTOM NAV
      "has-data-wf-bottom-nav:has-data-[wf-secondary-right-sidebar=collapsed]:**:data-wf-bottom-nav:mr-[calc(var(--secondary-right-sidebar-width-collapsed)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset))]",
    ],
  },
} as const;
...
function SafeAreaInsetTop({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-x-0 top-0 z-(--z-safe-area) h-[env(safe-area-inset-top)] bg-background",
        className,
      )}
      {...props}
    />
...
function SafeAreaInsetBottom({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-x-0 bottom-0 z-(--z-safe-area) h-[env(safe-area-inset-bottom)] bg-background",
        className,
      )}
      {...props}
    />
...
function SafeAreaInsetLeft({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-y-0 left-0 z-(--z-safe-area) w-[env(safe-area-inset-left)] bg-background",
        className,
      )}
      {...props}
    />
...
function SafeAreaInsetRight({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-y-0 right-0 z-(--z-safe-area) w-[env(safe-area-inset-right)] bg-background",
        className,
      )}
      {...props}
    />
      ...
      style={
        {
          ...
          // SECONDARY RIGHT SIDEBAR
          "--secondary-right-sidebar-width-expanded": parseCssVariable(
            config?.cssVariables?.["--secondary-right-sidebar-width-expanded"],
            tailwindSpacing(96),
          ),
          "--secondary-right-sidebar-width-collapsed": parseCssVariable(
            config?.cssVariables?.["--secondary-right-sidebar-width-collapsed"],
          ),
          "--secondary-right-sidebar-left-offset": parseCssVariable(
            config?.cssVariables?.["--secondary-right-sidebar-left-offset"],
          ),
          "--secondary-right-sidebar-right-offset": parseCssVariable(
            config?.cssVariables?.["--secondary-right-sidebar-right-offset"],
          ),
          "--secondary-right-sidebar-top-offset": parseCssVariable(
            config?.cssVariables?.["--secondary-right-sidebar-top-offset"],
          ),
          "--secondary-right-sidebar-bottom-offset": parseCssVariable(
            config?.cssVariables?.["--secondary-right-sidebar-bottom-offset"],
          ),
...
function WireframeSidebar({
  ...
  return (
    <div
      className={cn(
        "fixed z-50 overflow-scroll transition-[width] duration-200 ease-linear [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
        position === "left"
          ? [
              [
          ...
          : [
              ...
              "has-data-[wf-secondary-right-sidebar=expanded]:right-[calc(var(--secondary-right-sidebar-width-expanded)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset)+var(--right-sidebar-right-offset)+env(safe-area-inset-right))]",
              "has-data-[wf-secondary-right-sidebar=collapsed]:right-[calc(var(--secondary-right-sidebar-width-collapsed)+var(--secondary-right-sidebar-right-offset)+var(--secondary-right-sidebar-left-offset)+var(--right-sidebar-right-offset)+env(safe-area-inset-right))]",
            ],
        className,
      )}
      {...{
...
function WireframeSecondarySidebar({
  className,
  children,
  collapsed = false,
  ...props
  ...
  return (
    <div
      className={cn(
        "fixed z-50 overflow-scroll transition-[width] duration-200 ease-linear [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
        [
          "top-[calc(var(--secondary-right-sidebar-top-offset)+env(safe-area-inset-top))]",
          "right-[calc(var(--secondary-right-sidebar-right-offset)+env(safe-area-inset-right))]",
          "bottom-[calc(var(--secondary-right-sidebar-bottom-offset)+env(safe-area-inset-bottom))]",
        ],
        collapsed
          ? "w-(--secondary-right-sidebar-width-collapsed)"
          : "w-(--secondary-right-sidebar-width-expanded)",
        className,
      )}
      data-wf-secondary-right-sidebar={collapsed ? "collapsed" : "expanded"}
      {...props}
    >
      {children}
    </div>
...
function WireframeContent({
  ...
  return (
    <div
      className={cn(
        "flex min-h-[inherit] flex-col overscroll-y-contain pb-2 pr-2",
        className,
      )}
      {...props}
    >
