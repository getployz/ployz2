...
const SPINNER_FILES = {
  ...
  "routes/_protected/cloud/$organizationSlug/_org/-components/ClusterDomainSection.tsx": "Publish now in flight",
...
const COMMAND_FILES = {
  ...
  "routes/_protected/cloud/$organizationSlug/_org/~/settings.tsx": "Publish now calls Hosted DNS, an external service",
